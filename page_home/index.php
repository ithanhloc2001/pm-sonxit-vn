...
<style>
   ...
   ============================================================ */
    ...
    .lp-cmp-h-cheap i { color: #ff8a8a; font-size: 13px; }
    ...
    .lp-cmp-h-ro .lp-cmp-h-logo { height: 22px; object-fit: contain; }
    .lp-cmp-h-ro i { font-size: 13px; }
    ...
    .lp-cmp-row:hover { background: #fdfbf7; }
    ...
    .lp-cmp-icon { font-size: 18px; line-height: 1; flex-shrink: 0; }

    .lp-cmp-cheap { color: #888; }
    .lp-cmp-ro {
        color: #1d5c33;
        font-weight: 600;
    ...
    .lp-cmp-tag { display: none; }

    /* Last row — highlight */
    .lp-cmp-row.is-last { background: #0c4c29; }
    .lp-cmp-row.is-last:hover { background: #0c4c29; }
    .lp-cmp-row.is-last .lp-cmp-crit {
        background: #08331b;
        color: #fff;
    }
    .lp-cmp-row.is-last .lp-cmp-cheap { color: rgba(255, 255, 255, .55); }
   ...
   ============================================================ */
    ...
    @media (max-width: 600px) {
        .lp-mobile-only { display: block !important; }
   ...
   ============================================================ */
    @media (max-width: 960px) {
        ...
        .lp-vs-col { min-height: 310px; }

        .lp-vs-col-body { padding: 24px 18px; }
        ...
        .lp-cmp-header { display: none !important; }
        ...
        .lp-cmp-tag i { font-size: 10px; }

        .tag-cheap { background: #fff5f5; color: #e53e3e; border: 1px solid #fed7d7; }
        .tag-ro    { background: #ecfdf5; color: #10b981; border: 1px solid #dcfce7; }
        ...
        /* Audience */
        .lp-aud-cards { grid-template-columns: repeat(2, 1fr); }
        .lp-audience-top-right { display: none !important; }

        /* Features */
        .lp-features { grid-template-columns: repeat(2, 1fr); }

        /* BA */
        .lp-ba-grid { grid-template-columns: repeat(2, 1fr); }
        ...
        .lp-video-stats { flex-direction: column; }
        ...
        .lp-vstat:last-child { border-bottom: none; }

        /* Products */
        .lp-products-right { grid-template-columns: repeat(4, 1fr); }

        /* Timeline */
        .lp-timeline-imgs { grid-template-columns: repeat(5, 1fr); }
        ...
        .lp-timeline-track::before { display: none; }

        .lp-milestone { flex: 0 0 calc(50% - 10px); }

        /* Why */
        .lp-why-right { grid-template-columns: repeat(3, 1fr); }
   ...
   ============================================================ */
    @media (max-width: 600px) {
        ...
        .lp-section-badge { display: none !important; }
        ...
        /* VS section */
        .lp-vs-col ul li { font-size: 12.5px !important; }
        ...
        .lp-ba-trio::-webkit-scrollbar { display: none !important; }
        ...
        .lp-table-head { margin-bottom: 28px !important; }
        .lp-ba-trio-wrap { margin-bottom: 32px !important; }
        ...
        .lp-aud-cards::-webkit-scrollbar { display: none !important; }
        ...
        .lp-aud-card-img { height: 160px !important; }
        ...
        .lp-aud-card-top { padding: 28px 14px 18px !important; }

        .lp-aud-card h4 { font-size: 13px !important; }
        ...
        .lp-aud-nav-btn:hover { background: #0c4c29; color: #fff; }
        ...
        .lp-safety-right::-webkit-scrollbar { display: none !important; }
        ...
        .lp-safety-img-row { display: contents !important; }

        .lp-safety-left h2 { margin-bottom: 20px; }

        .lp-safety-item { gap: 12px !important; }
        ...
        .lp-video-thumb { height: 160px !important; }

        .lp-video-stats { display: none !important; }
        ...
        .lp-prod-img { height: 90px !important; }
        ...
        .lp-tl-carousel::-webkit-scrollbar { display: none !important; }
        ...
        .lp-why-left h2 { margin-bottom: 20px; }
        ...
        .lp-why-right::-webkit-scrollbar { display: none !important; }
        ...
        /* Bottom bar */
        .lp-bottom-bar { padding: 24px 16px; }
        ...
        .lp-bottom-bar-text { font-size: 13.5px !important; }
...
<div class="lp-page">
    ...
    <section class="lp-hero">
        <img class="hero-bg" src="image/hero_banner.png" alt="Rust-Oleum sơn xịt số 1 Hoa Kỳ"
            onerror="this.style.background='#d4c9b8';this.removeAttribute('src')">
        <div class="lp-hero-inner">
            <div class="lp-hero-content">
                <div class="lp-section-badge">SECTION 1 - HERO</div>
                <h1>
                    Rust-Oleum –<br>
                ...
                <p class="lp-hero-desc">Từ ghế sắt, xe đạp đến đồ decor, Rust-Oleum giúp tạo nên lớp hoàn thiện đẹp, bền và đáng công sức bạn bỏ ra.</p>
                <div class="lp-hero-btns">
                    <a href="/shopping" class="lp-btn-red">
    ...
    <section class="lp-compare">
        <div class="lp-compare-inner">
            ...
            <div class="lp-vs-wrap">
                ...
                <div class="lp-vs-mid">VS</div>
                <div class="lp-vs-col good">
                    <div class="lp-vs-col-img">
    ...
    <section class="lp-table-sec">
        <div class="lp-table-sec-inner">
            ...
            $rows = [
                ...
                ['🛡️', 'Độ che phủ',          'Cần nhiều lớp hơn',               'Độ che phủ cao hơn',                             false, false],
                ['⏱️', 'Thời gian thi công',  'Mất nhiều thời gian hơn',         'Hoàn thiện nhanh hơn',                           false, false],
                ['💨', 'Mùi sơn',             'Thường nồng hơn',                 'Dễ chịu hơn trong quá trình thi công',           false, true],
                ['🖐️', 'Cảm giác khi xịt',   'Dễ mỏi tay khi sử dụng lâu',      'Đầu xịt thiết kế tối ưu, thao tác nhẹ hơn',      false, true],
                ...
                ['⚠️', 'Nguy cơ làm lại',     'Cao hơn',                         'Thấp hơn',                                       false, true],
    ...
    <section class="lp-audience">
        <div class="lp-audience-inner">
            <div class="lp-audience-top">
                <div class="lp-audience-top-left">
                ...
                <div class="lp-audience-top-right">
    ...
    <section class="lp-video-sec">
        <div class="lp-video-inner">
            <div class="lp-video-left">
                ...
                <a href="/videos" class="lp-btn-red d-none d-md-inline-flex" style="margin-top:24px;align-self:flex-start;">
            ...
            <div class="lp-video-right">
                <div class="lp-video-grid">
                    <?php
                    $videos = [
                        ['img/img1.png', '00:52', 'Sơn ghế sắt',      'Biến chiếc ghế cũ thành điểm nhấn mới.'],
                        ['img/img3.png', '01:05', 'Sơn xe đạp',       'Bền màu, bám dính tốt cho kim loại.'],
                        ['img/img5.png', '00:48', 'Sơn decor',        'Thoả sức sáng tạo không giới hạn.'],
                        ['img/img2.png', '01:10', 'Review khách hàng', 'Cảm nhận thật từ người đã sử dụng.'],
                    ];
                    foreach ($videos as [$thumb, $dur, $title, $desc]): ?>
                        <div class="lp-video-card">
                            <div class="lp-video-thumb">
                                ...
                                <span class="lp-video-dur"><?= htmlspecialchars($dur) ?></span>
                            </div>
                ...
                <!-- Mobile CTA button -->
                <a href="/videos" class="lp-btn-red d-flex d-md-none justify-content-center text-center mt-3" style="width: 100%;">
                    <i class="bi bi-play-circle-fill"></i> Xem tất cả video
                </a>
    ...
    <section class="lp-products-sec">
        <div class="lp-products-inner">
            <div class="lp-products-left">
                ...
                <a href="/shop" class="lp-btn-red d-none d-md-inline-flex" style="margin-top:28px;align-self:flex-start;">
            ...
            <div class="lp-products-right">
                ...
                <!-- Mobile CTA button -->
                <a href="/shop" class="lp-btn-red d-flex d-md-none justify-content-center text-center mt-3" style="width: 100%; grid-column: span 4;">
                    Xem tất cả sản phẩm <i class="bi bi-chevron-right"></i>
                </a>
            </div>
        </div>
    ...
    <section class="lp-timeline-sec">
        <div class="lp-timeline-inner">
            ...
            <div class="lp-timeline-right">
                ...
                <div class="lp-timeline-imgs lp-pc-only">
                ...
                <div class="lp-timeline-track-wrap lp-pc-only">
    ...
    <section class="lp-why-sec">
        ...
        <div class="lp-final-cta">
            <a href="/shop" class="lp-btn-red" style="font-size:15px;padding:16px 36px;">
    ...
    <div class="lp-sticky-cta d-flex d-md-none" id="lpStickyCta">
        <a href="/shop" class="lp-sticky-buy">
            <i class="bi bi-cart-fill"></i> Mua ngay
        </a>
...
$(function() {
    ...
    (function() {
        ...
        function scrollTo(idx) {
            ...
            if (item) {
                $track[0].scrollTo({ left: item.offsetLeft - 16, behavior: 'smooth' });
            }
            $dots.removeClass('active').eq(current).addClass('active');
        }

        $prev.on('click', function() { scrollTo(current - 1); });
        $next.on('click', function() { scrollTo(current + 1); });
